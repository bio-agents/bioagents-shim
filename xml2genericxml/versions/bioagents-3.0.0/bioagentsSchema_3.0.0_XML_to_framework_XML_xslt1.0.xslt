...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:tbf="http://www.altova.com/MapForce/UDF/tbf" xmlns:xs="http://www.w3.org/2001/XMLSchema" exclude-result-prefixes="tbf xs">
	...
	<xsl:template match="/">
		...
		<root>
			<xsl:attribute name="xsi:noNamespaceSchemaLocation" namespace="http://www.w3.org/2001/XMLSchema-instance">file:///E:/repos/GitHub/bioagentsShim/xml2genericxml/versions/bioagents-3.0.0/bioagents-3.0.0_framework.xsd</xsl:attribute>
			<list>
				<xsl:for-each select="agents/agent">
					...
					<list-item>
						...
						<xsl:for-each select="summary/bioagentsID">
							<xsl:variable name="var3_cur" select="."/>
							<bioagentsID>
								<xsl:value-of select="."/>
							</bioagentsID>
						</xsl:for-each>
						<xsl:for-each select="summary/bioagentsCURIE">
						...
						<version>
							<xsl:for-each select="summary/version">
						...
						<otherID>
							<xsl:for-each select="summary/otherID">
						...
						<agentType>
							<xsl:for-each select="labels/agentType">
						...
						<topic>
							<xsl:for-each select="labels/topic">
						...
						<operatingSystem>
							<xsl:for-each select="labels/operatingSystem">
						...
						<xsl:for-each select="labels/license">
						...
						<collectionID>
							<xsl:for-each select="labels/collectionID">
						...
						<xsl:for-each select="labels/maturity">
							<xsl:variable name="var21_cur" select="."/>
							<maturity>
								<xsl:value-of select="."/>
							</maturity>
						</xsl:for-each>
						<xsl:for-each select="labels/cost">
						...
						<accessibility>
							<xsl:for-each select="labels/accessibility">
						...
						<iechorPlatform>
							<xsl:for-each select="labels/iechorPlatform">
						...
						<iechorNode>
							<xsl:for-each select="labels/iechorNode">
