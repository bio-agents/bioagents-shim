...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" exclude-result-prefixes="xs">
	...
	<xsl:template match="/">
		...
		<agents xmlns="bioagents schema">
			<xsl:attribute name="xsi:schemaLocation" namespace="http://www.w3.org/2001/XMLSchema-instance">bioagents schema file:///E:/repos/GitHub/bioagentsShim/genericxml2xml/versions/bioagents-3.3.0/bioagents_3.3.0.xsd</xsl:attribute>
			<xsl:for-each select="*[local-name()='root' and namespace-uri()='']/*[local-name()='list' and namespace-uri()='']/*[local-name()='list-item' and namespace-uri()='']">
				...
				<agent>
					...
					<xsl:for-each select="*[local-name()='bioagentsID' and namespace-uri()='']">
						<xsl:variable name="var3_cur" select="."/>
						<bioagentsID>
							<xsl:value-of select="."/>
						</bioagentsID>
					</xsl:for-each>
					<xsl:for-each select="*[local-name()='bioagentsCURIE' and namespace-uri()='']">
					...
					<xsl:for-each select="*[local-name()='agentType' and namespace-uri()='']/*[local-name()='list-item' and namespace-uri()='']">
					...
					<xsl:for-each select="*[local-name()='iechorPlatform' and namespace-uri()='']/*[local-name()='list-item' and namespace-uri()='']">
						<xsl:variable name="var20_cur" select="."/>
						<iechorPlatform>
							<xsl:value-of select="."/>
						</iechorPlatform>
					</xsl:for-each>
					<xsl:for-each select="*[local-name()='iechorCommunity' and namespace-uri()='']/*[local-name()='list-item' and namespace-uri()='']">
						<xsl:variable name="var21_cur" select="."/>
						<iechorCommunity>
							<xsl:value-of select="."/>
						</iechorCommunity>
					</xsl:for-each>
					<xsl:for-each select="*[local-name()='iechorNode' and namespace-uri()='']/*[local-name()='list-item' and namespace-uri()='']">
					...
					<xsl:for-each select="*[local-name()='relation' and namespace-uri()='']/*[local-name()='list-item' and namespace-uri()='']">
						...
						<relation>
							<bioagentsID>
								<xsl:value-of select="*[local-name()='bioagentsID' and namespace-uri()='']"/>
							</bioagentsID>
							<type>
								<xsl:value-of select="*[local-name()='type' and namespace-uri()='']"/>
							</type>
