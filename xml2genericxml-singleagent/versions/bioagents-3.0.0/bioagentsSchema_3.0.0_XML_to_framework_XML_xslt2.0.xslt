...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:tbf="http://www.altova.com/MapForce/UDF/tbf" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:fn="http://www.w3.org/2005/xpath-functions" exclude-result-prefixes="tbf xs fn">
	...
	<xsl:template match="/">
		<xsl:variable name="var1_agents" as="node()?" select="agents"/>
		<root>
			<xsl:attribute name="xsi:noNamespaceSchemaLocation" namespace="http://www.w3.org/2001/XMLSchema-instance" select="'file:///E:/repos/GitHub/bioagentsShim/xml2genericxml-singleagent/versions/bioagents-3.0.0/bioagents-3.0.0_framework_singleagent.xsd'"/>
			<xsl:for-each select="$var1_agents/agent">
				<name>
			...
			<xsl:for-each select="$var1_agents/agent/summary/bioagentsID">
				<bioagentsID>
					<xsl:sequence select="xs:string(xs:anyURI(fn:string(.)))"/>
				</bioagentsID>
			</xsl:for-each>
			<xsl:for-each select="$var1_agents/agent/summary/bioagentsCURIE">
				<bioagentsCURIE>
					<xsl:sequence select="xs:string(xs:anyURI(fn:string(.)))"/>
				</bioagentsCURIE>
			</xsl:for-each>
			<version>
				<xsl:for-each select="$var1_agents/agent/summary/version">
					<list-item>
						<xsl:sequence select="fn:string(.)"/>
					</list-item>
				</xsl:for-each>
			...
			<otherID>
				<xsl:for-each select="$var1_agents/agent/summary/otherID">
					<list-item>
			...
			<function>
				<xsl:for-each select="$var1_agents/agent/function">
					<list-item>
						<operation>
			...
			<agentType>
				<xsl:for-each select="$var1_agents/agent/labels/agentType">
					<list-item>
						<xsl:sequence select="fn:string(.)"/>
					</list-item>
				</xsl:for-each>
			...
			<topic>
				<xsl:for-each select="$var1_agents/agent/labels/topic">
					<list-item>
			...
			<operatingSystem>
				<xsl:for-each select="$var1_agents/agent/labels/operatingSystem">
					<list-item>
						<xsl:sequence select="fn:string(.)"/>
					</list-item>
				</xsl:for-each>
			...
			<language>
				<xsl:for-each select="$var1_agents/agent/labels/language">
					<list-item>
						<xsl:sequence select="fn:string(.)"/>
					</list-item>
				</xsl:for-each>
			</language>
			<xsl:for-each select="$var1_agents/agent/labels/license">
				<license>
					<xsl:sequence select="fn:string(.)"/>
				</license>
			</xsl:for-each>
			<collectionID>
				<xsl:for-each select="$var1_agents/agent/labels/collectionID">
					<list-item>
						<xsl:sequence select="fn:string(.)"/>
					</list-item>
				</xsl:for-each>
			</collectionID>
			<xsl:for-each select="$var1_agents/agent/labels/maturity">
				<maturity>
					<xsl:sequence select="fn:string(.)"/>
				</maturity>
			</xsl:for-each>
			<xsl:for-each select="$var1_agents/agent/labels/cost">
				<cost>
					<xsl:sequence select="fn:string(.)"/>
				</cost>
			</xsl:for-each>
			<accessibility>
				<xsl:for-each select="$var1_agents/agent/labels/accessibility">
					<list-item>
						<xsl:sequence select="fn:string(.)"/>
					</list-item>
				</xsl:for-each>
			...
			<iechorPlatform>
				<xsl:for-each select="$var1_agents/agent/labels/iechorPlatform">
					<list-item>
						<xsl:sequence select="fn:string(.)"/>
					</list-item>
				</xsl:for-each>
			...
			<iechorNode>
				<xsl:for-each select="$var1_agents/agent/labels/iechorNode">
					<list-item>
						<xsl:sequence select="fn:string(.)"/>
					</list-item>
				</xsl:for-each>
			...
			<link>
				<xsl:for-each select="$var1_agents/agent/link">
					<list-item>
			...
			<download>
				<xsl:for-each select="$var1_agents/agent/download">
					<list-item>
			...
			<documentation>
				<xsl:for-each select="$var1_agents/agent/documentation">
					<list-item>
			...
			<publication>
				<xsl:for-each select="$var1_agents/agent/publication">
					<list-item>
			...
			<credit>
				<xsl:for-each select="$var1_agents/agent/credit">
					<list-item>
