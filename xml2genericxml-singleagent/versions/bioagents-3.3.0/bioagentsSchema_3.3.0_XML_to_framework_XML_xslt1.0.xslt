...
-->
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:ns0="bioagents schema" xmlns:xs="http://www.w3.org/2001/XMLSchema" exclude-result-prefixes="ns0 xs">
	<xsl:output method="xml" encoding="UTF-8" indent="yes"/>
	<xsl:template match="/">
		<xsl:variable name="var1_initial" select="."/>
		<root>
			<xsl:attribute name="xsi:noNamespaceSchemaLocation" namespace="http://www.w3.org/2001/XMLSchema-instance">file:///E:/repos/GitHub/bioagentsShim/genericxml2xml-singleagent/versions/bioagents-3.3.0/bioagents-3.3.0_framework_singleagent.xsd</xsl:attribute>
			<xsl:for-each select="ns0:agents/ns0:agent">
				...
				<relation>
					<xsl:for-each select="ns0:relation">
						...
						<list-item>
							<bioagentsID>
								<xsl:value-of select="ns0:bioagentsID"/>
							</bioagentsID>
							<type>
								<xsl:value-of select="ns0:type"/>
							</type>
